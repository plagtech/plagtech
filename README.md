...
### 🌐 [Spraay x402 Gateway](https://gateway.spraay.app) — v3.3.0
...
- 📡 **62 paid + 5 free endpoints** | [Discovery →](https://gateway.spraay.app/.well-known/x402.json)
...
60 tools across 15 categories — connects Claude Desktop, Cursor, or any MCP-compatible AI to full-stack DeFi infrastructure on Base. Pay USDC per call via x402 protocol. Supabase-backed persistent storage.
...
| Protocol | Details |
|----------|---------|
| **x402 Gateway** | 62 paid + 5 free endpoints, Bazaar discoverable, v3.3.0 |
...
- [BlockRun awesome-blockrun](https://github.com/BlockRunAI/awesome-blockrun/pulls) — open
- [BlockRun awesome-OpenClaw-Money-Maker](https://github.com/BlockRunAI/awesome-OpenClaw-Money-Maker/pulls) — open
...
AI/Agents:     x402 Protocol, MCP, Coinbase AgentKit, ERC-8004, A2A, XMTP,
               BlockRun SDK, Virtuals ACP, Dexter
...
## 🎯 Current Focus
- 💧 Spraay x402 Gateway v3.3.0 — 62 paid endpoints, dual-provider AI (BlockRun + OpenRouter), Supabase persistence
- 🤖 MCP server v3.3.0 — 60 tools, live at mcp.spraay.app
- 🏪 Virtuals ACP — graduating to live marketplace
